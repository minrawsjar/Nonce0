...
///
/// Env: PRIVATE_KEY, and optionally DENOMINATION in 6-decimal units (defaults to
/// 1 USDC). USDC comes from deployments/arc-testnet.json, not an env var.
///
...
contract Deploy is Deployments {
    ...
    function run() external {
        ...
        _assertChain();
        // 6-decimal ERC-20 interface. The 18-decimal native USDC pays gas.
        address usdc = _usdc();
